...
#define STRING_CONFIG_H_AUTHOR "(bpivk)" // Who made the changes.
//#define CUSTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)
#define DIAG_PINS_REMOVED //Disabling nag message during compile
#define NO_AUTO_ASSIGN_WARNING //Disabling nag message during compile
// @section machine
...
#define PIDTEMPBED
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define DEFAULT_bedKp 150.13
    #define DEFAULT_bedKi 18.76
    #define DEFAULT_bedKd 800.98
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 800, 139.00 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, -13, -0.1 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 70, 70, 70, 70 } // (mm) Left, Front, Right, Back insets
